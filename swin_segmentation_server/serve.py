...
@click.option(
    ...
    "-sp",
    required=True,
    help="Path to the pretrained Swin Transformer model",
    default=None,
)
@click.option(
    "--configuration-path",
    "-cp",
    required=True,
    help="Path to the model's configuration file.  Located in the swin_segmentation_server/configs folder.",
    default=None,
)
@click.option(
    "--threshold",
